...
// creates new user
// missing validation on username: make sure username is not already in use
// missing validation on email: make sure no account already created with same email
